...
\node[gp node right] at (11.583,3.165) {60B(Unidir)};
...
\gpcolor{color=gp lt color border}
\node[gp node right] at (11.583,2.857) {60B(Bidir)};
...
\gpcolor{color=gp lt color border}
\node[gp node right] at (11.583,2.549) {1514B(Unidir)};
...
\gpcolor{color=gp lt color border}
\node[gp node right] at (11.583,2.241) {1514B(Bidir)};
